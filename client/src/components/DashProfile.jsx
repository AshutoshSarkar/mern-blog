...
export default function DashProfile() {
    ...
    uploadTask.on(
      ...
      (error) => {
        setImageFileUploadError(
          "Could not upload image (Your image size must be less than 5 MB)"
        );
  ...
  const handleChange = (e) => {
    // Update state variables directly for controlled inputs
  ...
  const handleSubmit = async (e) => {
    ...
    if (imageFileUploading) {
      setUpdateUserError("Please wait until image upload is complete");
      return;
    }
    ...
    <div className="max-w-lg mx-auto p-3 w-full">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        >
          ...
          <img
            src={imageFile ? ImageFileUrl : currentUser.profilePicture}
            alt="user"
        ...
        </Button>
        {
          currentUser.isAdmin && (
           <Link to={'/create-post'}>
            ...
            outline
           className="w-full" >Create a new Post</Button>
          </Link>
          )
        }
      </form>
